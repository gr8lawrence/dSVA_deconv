...
## We also remove the plasma cells from the signature matrix
library(tidyverse)
library(ggfortify)
library(ggrepel)
library(gprofiler2)
...
ggsave("Viral_challenge_plots/H1N1_Residual_PC1.pdf", width = 7.5, height = 9.5)
...
ggsave("Viral_challenge_plots/H1N1_Props_Line_Plots.pdf", width = 9.5, height = 7.5)

ggpubr::ggarrange(boxplot_nnls, boxplot_cutoff, common.legend = TRUE, legend = "bottom")
ggsave("Viral_challenge_plots/H1N1_Props_Boxplots.pdf", width = 9.5, height = 7.5)
...
ggsave("Viral_challenge_plots/H3N2_Residual_PC1.pdf", width = 7.5, height = 9.5)
...
ggpubr::ggarrange(line_plt_nnls, line_plt_cutoff, common.legend = TRUE, legend = "bottom")
ggsave("Viral_challenge_plots/H3N2_Props_Line_Plots.pdf", width = 9.5, height = 7.5)

ggpubr::ggarrange(boxplot_nnls, boxplot_cutoff, common.legend = TRUE, legend = "bottom")
ggsave("Viral_challenge_plots/H3N2_Props_Boxplots.pdf", width = 9.5, height = 7.5)
