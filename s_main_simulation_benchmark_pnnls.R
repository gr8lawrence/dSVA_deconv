...
if (q == 1) {
  pdf(paste0("plots/benchmark_sim_q_", q, "_", first_effect, "_20240322_pNNLS_be.pdf"))
} else if (q == 2) {
  pdf(paste0("plots/benchmark_sim_q_", q, "_", first_effect, "_", second_effect, "_20240322_pNNLS_be.pdf"))
}
print(p1)
print(p2)
print(p3)
